...
var ImageItem = function (_Component) {
    ...
    (0, _createClass3.default)(ImageItem, [{
        ...
        value: function render() {
            ...
            if (!image) {
                return _react2.default.createElement('div', { className: 'rpg-image-item-wrapper', style: customStyle });
            }

            customStyle.backgroundImage = 'url(' + (0, _util.combineUrlPath)(srcPrefix, src) + ')';
